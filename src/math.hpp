	...
	*/
	...
	class Suora {
		public:
			...
			//bool intersects(Point Piste);
			//bool intersects(Suora Suora);
	...
	class Ball {
		public:
			...
			float radius;
			Ball();
			//Point intersects(Point Piste);
			//Point intersects(Suora Suora);
			//Point intersects(Linesegment Linesegment);
			//Point intersects(Ball Circle);
			//Uint8 includes(Point Piste);  // Return: 0 if center point, 1 if inside, 2 if at circumference. 3 if outside
	};
